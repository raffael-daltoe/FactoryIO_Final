...
class EngineIO_Controller():
    ...
    def __init__(self, port='COM4', baudrate=9600, timeout=.5, rate=0.016, verbose=False):
...
if __name__ == "__main__":
    EngineIO_Controller(port='COM4', baudrate=9600, timeout=.5, rate=0.016,  verbose=True)
